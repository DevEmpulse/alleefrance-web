      ...
      >
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
            ...
            <strong>Visa Salarié</strong> (Estabilidad a largo plazo) y{" "}
            <strong>Visa Saisonnier</strong> (Trabajo por temporadas).
          </p>
          ...
          <AnimateOnScroll direction="fade" delay={0.1}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Analiza paso a paso cuál es la opción ideal para tu perfil
                profesional.
              </p>
            </div>
          </AnimateOnScroll>
          <p className="text-center text-gray-700 mb-8 md:hidden">
            Elige una visa para ver el proceso completo
          </p>
            ...
            >
              ...
              <AnimateOnScroll direction="right" delay={0.1}>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Es un permiso de residencia y trabajo destinado a personas
                    contratadas mediante un <strong>CDI</strong> (indefinido) o{" "}
                    <strong>CDD de larga duración</strong>.
                  </p>
                  <div className="bg-blue-50 p-3 rounded text-sm text-[#002654]">
                    <strong>Valor principal:</strong> Estabilidad, claridad
                    jurídica y proyección a largo plazo (residencia).
                  </div>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll direction="right" delay={0.2}>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h4 className="font-bold text-lg text-gray-800">
                      Oferta y Métier en Tension
                    </h4>
                  </div>
                  <p className="text-sm text-gray-600 mb-3">
                    Se requiere una oferta formal vinculada a un{" "}
                    <strong>código ROME</strong>. Si el puesto está en la lista
                    de <em>Métiers en Tension</em> (escasez de personal), el
                    proceso es <strong>más ágil</strong>.
                  </p>
                  <a
                  ...
                  >
                    <LinkIcon className="w-3 h-3" /> Consultar lista regional
                    (Légifrance)
                  </a>
                </div>
              </AnimateOnScroll>
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-gray-600">
                      <p className="mb-2">
                        Si el oficio <strong>NO</strong> está en tensión, es
                        obligatorio publicar la oferta por{" "}
                        <strong>21 días</strong> en France Travail para control
                        del mercado laboral.
                      </p>
                      <p className="text-xs bg-gray-100 p-2 rounded">
                        <strong>Importante:</strong> Cualquier modificación
                        reinicia el contador de 21 días.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    ...
                    <li className="flex gap-2">
                      ...
                      <span>
                        Revisión autorización: <strong>2 a 8 semanas</strong>.
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <FileText className="w-4 h-4 text-[#002654]" />
                      <span>
                        Emisión visa (Consulado): <strong>~15 días</strong>.
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <AnimateOnScroll direction="right" delay={0.5}>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Al llegar, es <strong>obligatorio</strong> validar la visa
                    online, registrarse en seguridad social y activar derechos
                    laborales.
                  </p>
            ...
            >
              ...
              <AnimateOnScroll direction="left" delay={0.1}>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Para trabajos estacionales (Hotelería, Agro, Turismo, Ski)
                    con contratos de <strong>3 a 6 meses</strong>.
                  </p>
                  <div className="bg-red-50 p-3 rounded text-sm text-[#ED2939]">
                    <strong>Limitación:</strong> No otorga derecho anual. Máximo
                    6 meses de trabajo por año. Renovable por 3 años
                    consecutivos.
                  </div>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll direction="left" delay={0.2}>
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Muchos oficios estacionales pertenecen a{" "}
                    <em>Métiers en Tension</em>, especialmente en regiones
                    turísticas, facilitando la aprobación.
                  </p>
                  <div className="flex flex-wrap gap-2 mt-2">
                    {["Hotelería", "Restauración", "Montaña", "Agro"].map(
                      (tag) => (
                        <span
                          key={tag}
              ...
              <AnimateOnScroll direction="left" delay={0.3}>
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-gray-600">
                      <p className="mb-2">
                        En la mayoría de casos estacionales (alta demanda),{" "}
                        <strong>NO es necesario</strong> publicar la oferta por
                        3 semanas.
                      </p>
                      <p className="text-xs text-gray-500">
                        *Solo si el oficio no es estacional ni está en tensión,
                        se requieren los 21 días.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    ...
                    <li className="flex gap-2">
                      ...
                      <span>
                        Emisión visa: <strong>~15 días</strong>.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-50 p-2 rounded text-sm border border-gray-200">
                      <span className="font-bold text-[#002654]">
                        Menos de 3 meses:
                      </span>{" "}
                      NO se valida. Sin trámites extra.
                    </div>
                    <div className="bg-gray-50 p-2 rounded text-sm border border-gray-200">
                      <span className="font-bold text-[#002654]">
                        3 a 6 meses:
                      </span>{" "}
                      Validación obligatoria + Carte de Séjour Saisonnier.
                    </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-base text-gray-700 leading-relaxed space-y-3">
                          ...
                          <p>
                            ...
                            (desde pequeños negocios familiares hasta grandes
                            empresas) para asegurar un expediente limpio,
                            completo y aprobado en tiempo récord.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-lg text-white/95 leading-relaxed mb-6">
                          No estás solo en este proceso. Únete a nuestra
                          comunidad de WhatsApp para compartir experiencias y
                          consejos.
                        </p>
                        <a
                          href="https://chat.whatsapp.com/Jp7yTFyDhAM3i4dhHW0m8Z"
            ...
            <div className="mt-16 text-center">
              ...
              >
                ...
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                  Gestionamos procesos limpios, completos y aprobables. Evita
                  errores y retrasos.
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Para CDI o CDD Largo.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />{" "}
                  <span>Permite residencia a largo plazo.</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-orange-500 mt-0.5" />{" "}
                  <span>
                    Publicación de 21 días obligatoria si no es "en tension".
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <Euro className="w-4 h-4 text-gray-500 mt-0.5" />{" "}
                  <span>Tiene tasas consulares estándar.</span>
                </li>
              </ul>
            </Card>
            ...
            >
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />{" "}
                  <span>Contratos de 3 a 6 meses.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />{" "}
                  <span>Generalmente NO requiere publicación de 21 días.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-600 mt-0.5" />{" "}
                  <span>
                    <strong>Costo 0€</strong> (Gratuita).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-orange-500 mt-0.5" />{" "}
                  <span>Limitada a 6 meses por año.</span>
                </li>
              </ul>
            </Card>
          </div>
