...
const timeline = [
  {
    month: "Mes 1",
    detail:
      "Definí sector, región y contactos. prepara CV/Carta en francés y empieza a enviar candidaturas.",
  },
  {
    month: "Mes 2",
    detail:
      "Cerrá contrato + promesa de empleo, reune documentación personal y pide turno consular.",
  },
  {
    month: "Mes 3",
    detail:
      "Entrevista en el consulado, espera del pasaporte y organización del viaje (seguro, alojamiento, llegada).",
  },
];
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center text-white relative z-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold mb-6">
            Visa saisonnier o Salarié: Guía 2024
          </h1>
          <p className="text-xl leading-relaxed mb-6">
            Cómo conseguir un contrato temporal, preparar tu dossier y presentar
            la visa sin cometer los errores que más rechazos generan.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <article className="space-y-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Permite trabajar en Francia entre 3 y 6 meses (renovable hasta 9)
              en sectores con demanda temporal. La empresa francesa inicia el
              expediente y valida el contrato ante la DIRECCTE o mediante la
              plataforma ANEF. Con ese contrato y una carta de motivación
              consistente demostrás que volverás al finalizar la temporada.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              No necesitás demostrar francés perfecto, pero sí entender las
              tareas básicas. Contar con experiencia relacionada, cursos cortos
              o referencias laborales ayuda a que Recursos Humanos confíe en tu
              perfil y acelere el trámite.
            </p>
          </article>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-6 rounded-2xl shadow-lg border border-gray-100">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>
                  Fondos mínimos de 600 € mensuales si el empleador no cubre
                  alojamiento
                </li>
            ...
            <div className="p-6 rounded-2xl shadow-lg border border-gray-100">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>
                  Puedes cambiar a una visa de trabajo larga si recibís un CDI
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              <li>
                Agendá el turno apenas recibas el contrato; en temporada alta se
                agotan rápido.
              </li>
              <li>
                Si tu empleador cubre alojamiento o comidas, pide que lo
                indiquen por escrito para justificar fondos menores.
              </li>
              <li>
                Incluí cartas de recomendación traducidas al francés para
                fortalecer tu perfil.
              </li>
              <li>
                Organiza el dossier en el orden que pide el consulado y llevá
                copias extra.
              </li>
            </ul>
          </div>
