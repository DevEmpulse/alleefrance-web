...
export function HeroSection() {
  ...
  return (
    <section id="inicio" className="relative overflow-hidden">
      <div
        className="relative min-h-[700px] lg:min-h-[850px] xl:min-h-[870px] pt-16"
      ...
      >
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-blue-700/45 pointer-events-none" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-40 lg:pt-48 pb-40 text-center">
          ...
          >
            <Button
              ...
              asChild
            >
              <Link href={`/${locale}/servicios/visas-trabajo`}>{t("workVisaCta")}</Link>
            </Button>
            ...
            <Button
              ...
              asChild
            >
              <Link href={`/${locale}/working-holiday`}>{t("workingHolidayCta")}</Link>
            </Button>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl px-3 sm:px-6 py-3 sm:py-5 w-[140px] sm:w-auto">
            <div className="flex flex-col gap-1 sm:gap-2">
              ...
              <div className="flex items-baseline gap-0.5 sm:gap-1 flex-wrap">
                <span
                  className="text-xl sm:text-3xl lg:text-4xl font-bold leading-none"
                  style={{ color: "#DC1F2E" }}
                >
