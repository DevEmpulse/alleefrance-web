...
const COUNTRY_DATA: Record<
  WorkingHolidayCountryCode,
  WorkingHolidayCountryConfig
> = {
  global: {
    code: "global",
    name: "Latinoamérica",
  ...
  uy: {
    ...
    keyDates: ["Nueva Zelanda: Agosto", "Reino Unido: Enero y Julio (Ballot)"],
